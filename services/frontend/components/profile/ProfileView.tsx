...
// Presentational + data component ported verbatim from the OLD app route
// app/routes/profile/profile.tsx. The UI is pixel-identical to the old screen:
// a read-only "User Information" card plus a "Profile Editing Coming Soon"
// notice. Data is fetched from /auth/me via the shared fetch-util helper, the
// exact same call site as the old app.
