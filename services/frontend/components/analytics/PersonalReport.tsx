...
// (the `reportData ? (...)` detailed-report branch, sections 1-10).
// JSX + Tailwind + Figma hex + emojis copied VERBATIM for pixel-exact UI.
...
export function PersonalReport({ reportData, canDownload, onDownloadExcel, onPrint }: PersonalReportProps) {
  return (
