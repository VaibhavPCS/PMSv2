...
// Ported VERBATIM from OLD app/features/analytics/components/VelocityChart.tsx.
// recharts config copied unchanged.
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={320}>
          <LineChart data={formattedData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <XAxis dataKey="formattedDate" stroke="#6b7280" tick={{ fontSize: 12 }} />
            <YAxis
              stroke="#6b7280"
              tick={{ fontSize: 12 }}
              label={{
